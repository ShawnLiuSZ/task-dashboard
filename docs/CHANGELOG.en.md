...
- **Unreleased — Sidebar collapses to icon-only on narrow windows (#265)**
...
- **Unreleased — Notes page: full-width panel + four side-by-side columns + create-column-only collapse (#259)**
