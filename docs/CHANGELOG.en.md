...
- **Unreleased — Add project open-source license (#281)**
...
- **Unreleased — Automated post-merge cleanup: delete branch + close linked issues (#284)**
...
- **Unreleased — Task detail shows parent / sub issues with open & copy actions (#278)**
