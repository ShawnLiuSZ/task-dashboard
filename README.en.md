...
- [`docs/CHANGELOG.md`](./docs/CHANGELOG.md) — per-version update & fix log (v0.3.1 → latest v0.5.1)
...
> Version v0.5.1 · Local cross-platform app (Windows / macOS / Linux), 2026-09-15